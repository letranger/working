"""
created_at_utc  : 2022-10-28T06:31:37Z
created_at_w3c  : 2022-10-28T14:31:37+08:00
...
class MLPlay:
    def __init__(self, ai_name, *args, **kwargs):
        global _E5_89_8D_E7_90_83x_E5_BA_A7_E6_A8_99, _E7_99_BC_E7_90_83_E4_BD_8D_E7_BD_AE, _E5_89_8D_E7_90_83y_E5_BA_A7_E6_A8_99, _E7_99_BC_E7_90_83_E6_96_B9_E5_90_91, 模型回傳值1, 模型預測值1, 模型, 模型預測值2
            ...
            if not scene_info['ball_served']:
                while not (_E7_99_BC_E7_90_83_E4_BD_8D_E7_BD_AE - 30 <= scene_info['platform'][0] and scene_info['platform'][0] <= _E7_99_BC_E7_90_83_E4_BD_8D_E7_BD_AE - 10):
                    if _E7_99_BC_E7_90_83_E4_BD_8D_E7_BD_AE <= scene_info['platform'][0] + 40 / 2:
                        ...
                        return "MOVE_RIGHT"
                if _E7_99_BC_E7_90_83_E6_96_B9_E5_90_91 == 1: #隨機
                    return "SERVE_TO_LEFT"
                else:
                    return "SERVE_TO_RIGHT"
            else:
                模型回傳值1 = scene_info['ball'][0] - _E5_89_8D_E7_90_83x_E5_BA_A7_E6_A8_99
                _E5_89_8D_E7_90_83x_E5_BA_A7_E6_A8_99 = scene_info['ball'][0]
                # 利用AI模型預測移動方向，1代表向右移動，2代表向左移動
                # 這裡的特徵資料一定要跟遊戲收集的一樣喔!!
                模型預測值1 = 模型.predict([[scene_info['ball'][0], scene_info['ball'][1], 模型回傳值1, scene_info['platform'][0]]]).tolist()
                模型預測值2 = 模型預測值1[0]
                if 模型預測值2 == 1:
                    return "MOVE_LEFT"
                elif 模型預測值2 == 2:
