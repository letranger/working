"""
created_at_utc  : 2022-10-28T07:26:09Z
created_at_w3c  : 2022-10-28T15:26:09+08:00
...
class MLPlay:
    def __init__(self, ai_name, *args, **kwargs):
        global _E5_89_8D_E7_90_83x_E5_BA_A7_E6_A8_99, _E7_99_BC_E7_90_83_E4_BD_8D_E7_BD_AE, _E5_89_8D_E7_90_83y_E5_BA_A7_E6_A8_99, _E7_99_BC_E7_90_83_E6_96_B9_E5_90_91, _E7_90_83_E7_9A_84x_E6_96_B9_E5_90_91, 模型預測結果1, 模型, 模型預測結果2
    ...
    def update(self, scene_info, keyboard=[], *args, **kwargs):
        ...
        if scene_info['status'] != "GAME_ALIVE":
            ...
            if not scene_info['ball_served']:
                ...
                # 這裡的特徵資料一定要跟遊戲收集的一樣喔!!
                模型預測結果1 = 模型.predict([[scene_info['ball'][0], scene_info['ball'][1], _E7_90_83_E7_9A_84x_E6_96_B9_E5_90_91, scene_info['platform'][0]]]).tolist()
                模型預測結果2 = 模型預測結果1[0]
                if 模型預測結果2 == 1:
                    return "MOVE_LEFT"
                elif 模型預測結果2 == 2:
