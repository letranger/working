...
2. 每月3000，每月月初第一個交易日全數投入
3. 分三種投資項目
4. 自訂比例，項目數不得低於三類，每類比例不得低於20%
5. 每年年底(12月)多一筆入帳：10000
6. 股票可併年度配股配息，只要基於真實數據均可列入獲利
7. 定存、定儲需依實際年度利息進行計算
8. 其他期貨、選擇權、政府公債等請自行解決
9. 六年中只能每月定期買進（不可短進短出）
10. 不考慮手續費、證交稅、等因素
*** Group Tasks
1. 小組討論投資項目
2. 收集六年中每月資訊
...
* Part II: How AI Could Make Everyone Rich
** Let's Get Greedy
